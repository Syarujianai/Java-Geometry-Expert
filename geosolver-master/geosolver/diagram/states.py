...
class ImageSegmentParse(object):
    ...
    def display_instances(self, instances, block=True, display_label=False, match_position=None, **kwargs):
        display_image(self.get_image_instances(instances, **kwargs), block=block, display_label=display_label, match_position=match_position)
...
class CoreParse(object):
    ...
    def get_image_points(self, display_label=True, **kwargs):
    ...
    def display_points(self, display_label=True, block=True, **kwargs):
        image = self.get_image_points(display_label, **kwargs)
        display_image(image, block=block)
